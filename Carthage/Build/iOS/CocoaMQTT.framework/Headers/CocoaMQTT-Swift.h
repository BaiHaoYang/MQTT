...
SWIFT_MODULE_NAMESPACE_PUSH("CocoaMQTT")
@class CocoaMQTTWill;
...
@property (nonatomic, copy) NSDictionary<NSNumber *, NSString *> * _Nonnull subscriptions;
...
@interface CocoaMQTT (SWIFT_EXTENSION(CocoaMQTT)) <GCDAsyncSocketDelegate>
...
/// Conn Ack
typedef SWIFT_ENUM(uint8_t, CocoaMQTTConnAck) {
...
/// MQTT Will Message
SWIFT_CLASS("_TtC9CocoaMQTT13CocoaMQTTWill")
